interface Window {
  pb: {
    ...
    fireEnhance: (data: { frontPath: string | null; backPath: string | null; notes: string; strictSilhouette: boolean }) => Promise<{ success: boolean; outputs: Array<{ view: string; outputPath: string }>; error?: string }>
